...
class Generate_Differences:
    ...
    """ This Function generates the potential differences between the input 
    text and the original input license text/template  """
    ...
    def generate_difference(self,copy_license):
        ...
        matches = difflib.SequenceMatcher(
            None, self.constant_license, self.license_to_match).get_matching_blocks()
